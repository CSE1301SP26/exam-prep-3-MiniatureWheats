...
public class SolarSystem {
	...
	public static void main(String[] args) {
		// Write a line of code that creates an instance of the Planet class by calling
		// the constructor. You should
		// also declare a variable to hold the newly created instance.
		Planet jupiter = new Planet("Jupiter", 256783);
		Planet saturn = new Planet("Saturn", 174592);

		// Write a line of code that creates an instance of the SolarSystem class by
		// calling the constructor. You
