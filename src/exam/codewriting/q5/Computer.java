...
public class Computer {
    ...
    /*
     * We wish to create a Computer class. Specifically, we are interested in
     * keeping track of the state of the computer, i.e. whether the computer is on,
     * off, or in sleep mode. For this problem, you have already been provided with
     * the necessary instance variables for the Computer class.
     * 
     * Complete each item of the implementation of the class in the designated
     * areas. Use appropriate names, data types, and modifiers based on the story
     * above:
     */
    ...
    /**
     * If the button press is short, the computer should go to sleep (but remain
     * on),
